...
EOF
	...
	# AUR/OBS helper selection (Arch-based only, OBS is native in openSUSE)
	case "${DISTRO_ID}" in
	...
	opensuse | opensuse-leap | opensuse-tumbleweed)
		print_log -sec "OBS" -stat "integrated" "OBS is handled automatically by zypper, no helper selection needed"
		;;
	esac
